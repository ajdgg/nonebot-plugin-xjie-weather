...
LastEditTime: 2024-06-03 20:05:02
FilePath: \XJieBot\src\plugins\main\plugins\nonebot_plugin_xjie_weather\get_weather.py
...
class get_weather:
    ...
    def xj_get_weather_main(self,city_name:str, get_default_platform:str=None):
        if get_default_platform == None or get_default_platform == '':
            MR_AP = a_qf(key_data)
